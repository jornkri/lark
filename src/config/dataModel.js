    ...
    drawingInfo: {
      renderer: {
        ...
        symbol: {
          type: "esriSFS",
          style: "esriSFSSolid",
          color: [178, 220, 138, 190],
          outline: { type: "esriSLS", style: "esriSLSSolid", color: [88, 148, 58, 220], width: 1.5 },
        },
      },
    },
  },
    ...
    drawingInfo: {
      renderer: {
        ...
        symbol: {
          ...
          style: "esriSFSSolid",
          color: [94, 158, 68, 210],
          outline: { type: "esriSLS", style: "esriSLSSolid", color: [35, 95, 22, 255], width: 1.2 },
        },
      },
    },
  },
    ...
    drawingInfo: {
      renderer: {
        ...
        symbol: {
          ...
          color: [45, 112, 56, 255],
          size: 16,
          outline: { color: [148, 210, 120, 255], width: 2.5 },
        },
      },
    },
  },
...
fields: [
    ...
    drawingInfo: {
      renderer: {
        type: "simple",
        symbol: { type: "esriSLS", style: "esriSLSSolid", color: [200, 168, 120, 255], width: 3 },
      },
    },
  },
    ...
    drawingInfo: {
      renderer: {
        ...
        symbol: {
          type: "esriSFS",
          style: "esriSFSSolid",
          color: [208, 203, 187, 175],
          outline: { type: "esriSLS", style: "esriSLSSolid", color: [148, 142, 126, 255], width: 1 },
        },
      },
    },
  },
    ...
    drawingInfo: {
      renderer: {
        ...
        symbol: {
          type: "esriSFS",
          style: "esriSFSSolid",
          color: [150, 200, 224, 190],
          outline: { type: "esriSLS", style: "esriSLSSolid", color: [52, 138, 196, 255], width: 1.5 },
        },
      },
    },
  },
    ...
    drawingInfo: {
      renderer: {
        ...
        symbol: {
          ...
          color: [200, 120, 50, 255],
          size: 10,
          outline: { color: [120, 65, 10, 255], width: 1.5 },
        },
      },
    },
  },
    ...
    drawingInfo: {
      renderer: {
        ...
        symbol: {
          type: "esriSFS",
          style: "esriSFSSolid",
          color: [188, 168, 130, 200],
          outline: { type: "esriSLS", style: "esriSLSSolid", color: [108, 80, 44, 255], width: 1.8 },
        },
      },
    },
  },
